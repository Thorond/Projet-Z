...
public class GrotteF5Salle1 extends Sprite {
    ...
    public static void sousMap(GameMain game, int x, int y){
        ...
        if ( porteGauche == false ){
            ...
            game.getBatch().draw(ClimatMontagneux.emplacementBombe, 60+ x, 270+ y);
        }
    ...
    public static void createBodyAndType(World world) {
        ...
        if ( isCote1Created == false ) {
            cote1 = ClimatMontagneux.createBody(560,240,60,480);
            isCote1Created = true;
        }
        if ( porteGauche == false ){

            if ( isCote2Created == false ) {
                cote2 = ClimatMontagneux.createBody(20,240,60,420);
                isCote2Created = true;
            }

            if (CadrillageMap.typeDeDécor[0][4].equals("détruit")
                    || CadrillageMap.typeDeDécor[0][5].equals("détruit")) {
                porteGauche = true;
            ...
            if ( isCote2Created == false ) {
                cote2 = ClimatMontagneux.createBody(20,120,60,210);
                isCote2Created = true;
            }
        }
        if ( isCote3Created == false ) {
            cote3 = ClimatMontagneux.createBody(20,420,60,120);
            isCote3Created = true;
        }
