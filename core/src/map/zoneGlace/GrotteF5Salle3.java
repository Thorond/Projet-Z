...
public class GrotteF5Salle3 extends Sprite {
    ...
    public static void sousMap(GameMain game, int x, int y){
        ...
        game.getBatch().draw(ClimatMontagneux.murSombreGlacéCentre, 480+ x, 240+ y);
    ...
    public static void createBodyAndType(World world) {
        ...
        if ( isCote7Created == false ) {
            cote7 = ClimatMontagneux.createBody(200,90,60,60);
            isCote7Created = true;
        }
        if ( isCote8Created == false ) {
            cote8 = ClimatMontagneux.createBody(460,270,120,60);
            isCote8Created = true;
        }

        if ( !(isReceptaclePris)) CadrillageMap.setTypeDeDécor(420/60, 120/60, "receptacleDeCoeur");
    }
